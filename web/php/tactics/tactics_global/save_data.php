...
//查询数据库是否有相同记录
$sql = "select ID from tactics_global where Tactics_type like '$Tactics_type' and Detail like '$Detail'";
...
if($array) {
	...
	$sql = "insert into tactics_global(Tactics_type, Detail, Enable, Comment) values('$Tactics_type', '$Detail', '$Enable', '$Comment')";
	$result = @mysql_query($sql);
