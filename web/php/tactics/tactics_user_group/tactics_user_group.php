...
<head>
	...
	<link type="text/css" rel="stylesheet" href="../../../css/tactics_user_group.css">
	...
	<script type="text/javascript" src="../../../js/tactics_user_group.js"></script>
</head>
<body>
	...
	<div data-options="region: 'center', border: false">
		<table id="dg" style="background:#eee;">
			...
			<tr>
				...
				<th field="Name" width="50" sortable="true" align="center">组名</th>
				<th field="Gid" width="50" sortable="true" align="center">组号</th>
...
<div id="dlg" class="easyui-dialog" style="width:510px;height:380px;padding:10px 20px"
	...
	<form id="fm" method="post" novalidate>
		<ul>
			<li>
				<div class="fitem">
					<label class="label">组信息:</label>
					<select class="easyui-combogrid" id="Gid" name="Gid" data-options="
						panelWidth: 222,
						panelHeight: '200',
						idField: 'Gid',
						textField: 'Name',
						url: 'combogrid_user_group.php',
						mode: 'remote',
						delay: 500,
						required: true,
						editable: true,
			...
			<li>
				<div class="fitem">
					...
					<input type="radio" class="radio" checked="checked" name="Enable" value="1"/>是 &nbsp;&nbsp;&nbsp;&nbsp;
