...
//查询数据库是否有相同记录
$sql = "select ID from tactics_allow where Uid like '$Uid' and Tactics_type like '$Tactics_type' and Detail like '$Detail'";
...
if($array) {
	...
	$sql = "insert into tactics_allow (Name, Uid, User_IP, Tactics_type, Detail, Enable, Comment) values ('$Name', '$Uid', '$IP', '$Tactics_type', '$Detail', '$Enable', '$Comment')";
