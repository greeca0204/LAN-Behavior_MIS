...
<head>
	...
	<link type="text/css" rel="stylesheet" href="../../../css/tactics_allow.css">
	...
	<script type="text/javascript" src="../../../js/tactics_allow.js"></script>
</head>
<body>
<div class="easyui-layout" fit="true">
	<div data-options="region: 'north', title:'查询条件', border: false" style="height: 103px;">
		<!--搜索条件-->
		<div class="easyui-panel" id="p" style="background: #eee; min-width: 1100px; overflow-y: hidden;"
		     data-options="closable:false,  collapsible:true, minimizable:false, maximizable:false, fit: true, border: false">
			<form id="pForm">
				<table>
					<tr>
						<td>
	...
	<div data-options="region: 'center', border: false" style="background:#eee;">
		<table id="dg" class="easyui-datagrid" fit="true" border="false"
		       url="get_data.php" pageSize="20" pageList="[20,40,60,80,100]"
