...
//查询数据库是否有相同记录
$sql = "select ID from tactics_user where ID != '$ID' and Uid like '$Uid' and Tactics_type like '$Tactics_type' and Detail like '$Detail'";
...
if($array) {
	...
	$sql = "update tactics_user set Name='$Name', Uid='$Uid', User_IP='$IP', Tactics_type='$Tactics_type', Detail='$Detail', Enable='$Enable', Comment='$Comment' where ID='$ID'";
	$result = @mysql_query($sql);
	if($result) {
