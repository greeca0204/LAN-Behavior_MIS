...
$rs = mysql_query("select count(distinct Uid) from audit_search where Uid like '%$searchUid%' and Name like '%$searchName%' and User_IP like '%$searchIP%'");
$array = mysql_fetch_array($rs);
$result["total"] = $array[0];
$rs = mysql_query("select * from audit_search where Uid like '%$searchUid%' and Name like '%$searchName%' and User_IP like '%$searchIP%' group by Uid order by $sort $order limit $offset, $rows");
